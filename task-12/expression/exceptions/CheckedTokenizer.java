...
class CheckedTokenizer {
    ...
    private void readNumber(boolean negative) throws ParseException {
        int result = 0;
        lastPosition = index - (negative ? 1 : 0);
    ...
    void nextToken(boolean readNegativeNumber) throws ParseException {
        skipWhitespace();
